// ignore_for_file: prefer_final_fields, prefer_typing_uninitialized_variables, await_only_futures, file_names
...
class EditJurnal extends StatefulWidget {
  const EditJurnal({super.key});

  @override
  State<EditJurnal> createState() => _EditJurnalState();
}

class _EditJurnalState extends State<EditJurnal> {
  double spaceField = 7;
  ...
  void updateJurnal() async {
    ...
    if (_formKey.currentState!.validate()) {
      ...
      await jurnalRef.collection('jurnal').doc(jurnal.uid).update({
  ...
  Widget build(BuildContext context) {
    if (jurnal == null) {
      jurnal = ModalRoute.of(context)!.settings.arguments;
